 ...
 */
public class MethodCoverageInfoProvider
    ...
    public MethodCoverageInfoProvider(ProviderParameters booterParameters)
    {
    ...
    */
    ...
    {
        return scanResult.applyFilter(jUnit4TestChecker, testClassLoader);
    }
    ...
    private void execute( Class<?> testClass, RunNotifier fNotifier, String[] testMethods )
            throws TestSetFailedException
    {
        if ( null != testMethods)
        {
